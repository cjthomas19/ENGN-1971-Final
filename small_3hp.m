...
J = .089; % Inertia constant, J*s^2 = kg*m

Z_B = V_B / I_B;

r_s = 0.435/Z_B; % Stator winding resistance
r_r_p = 0.816/Z_B;
X_ls = 0.754/Z_B; % Stator leakage reactance  at rated freq
X_M = 26.13/Z_B; % Stator q-axis reactance at rated freq
X_lr_p = 0.754/Z_B; % Stator d-axis reactance at rated freq
